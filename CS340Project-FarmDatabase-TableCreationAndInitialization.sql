...
INSERT INTO employee_plot (plot_id, employee_id) VALUES 
	(1, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(2, (SELECT id from employee where first_name = 'Richard' and last_name = 'Thomas')),
	(3, (SELECT id from employee where first_name = 'Christina' and last_name = 'Florence')),
	(4, (SELECT id from employee where first_name = 'Kara' and last_name = 'Applebee')),
	(5, (SELECT id from employee where first_name = 'Jovita' and last_name = 'Yates')),
	(6, (SELECT id from employee where first_name = 'Paul' and last_name = 'Rogers')),
	(7, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(8, (SELECT id from employee where first_name = 'Richard' and last_name = 'Thomas')),
	(9, (SELECT id from employee where first_name = 'Christina' and last_name = 'Florence')),
	(10, (SELECT id from employee where first_name = 'Kara' and last_name = 'Applebee')),
	(11, (SELECT id from employee where first_name = 'Jovita' and last_name = 'Yates')),
	(12, (SELECT id from employee where first_name = 'Paul' and last_name = 'Rogers')),
	(13, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(14, (SELECT id from employee where first_name = 'Richard' and last_name = 'Thomas')),
	(15, (SELECT id from employee where first_name = 'Christina' and last_name = 'Florence')),
	(16, (SELECT id from employee where first_name = 'Kara' and last_name = 'Applebee')),
	(17, (SELECT id from employee where first_name = 'Jovita' and last_name = 'Yates')),
	(18, (SELECT id from employee where first_name = 'Paul' and last_name = 'Rogers')),
	(19, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(20, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(1, (SELECT id from employee where first_name = 'Richard' and last_name = 'Thomas')),
	(2, (SELECT id from employee where first_name = 'Christina' and last_name = 'Florence')),
	(3, (SELECT id from employee where first_name = 'Kara' and last_name = 'Applebee')),
	(4, (SELECT id from employee where first_name = 'Jovita' and last_name = 'Yates')),
	(5, (SELECT id from employee where first_name = 'Paul' and last_name = 'Rogers')),
	(6, (SELECT id from employee where first_name = 'Adam' and last_name = 'Smith')),
	(7, (SELECT id from employee where first_name = 'Richard' and last_name = 'Thomas')),
	(8, (SELECT id from employee where first_name = 'Christina' and last_name = 'Florence')),
	(9, (SELECT id from employee where first_name = 'Kara' and last_name = 'Applebee')),
	(10, (SELECT id from employee where first_name = 'Jovita' and last_name = 'Yates'));
...
INSERT INTO animal (plot, slaughter_date, dob_or_doa, type)
	VALUES  (1, '2014-08-09', '2018-05-19', 'Cow'),
		    (1, '2014-08-09', '2018-04-19', 'Cow'),
		    (1, '2014-08-09', '2018-05-03', 'Cow'),
			(2, '2014-08-09', '2018-05-07', 'Cow'),
			(2, '2014-08-09', '2018-05-11', 'Cow'),
			(2, '2014-08-09', '2018-04-02', 'Cow'),
			(null, null, '2013-02-02', 'Dog'),
			(null, null, '2013-11-04', 'Dog'),
			(null, null, '2015-05-13', 'Cat'),
			(null, null, '2012-06-04', 'Cat'),
			(3, '2018-09-05', '2012-06-04', 'Pig'),
			(4, '2018-09-05', '2012-06-12', 'Pig'),
			(3, '2018-09-05', '2015-06-21', 'Large Pig'),
			(4, '2018-09-05', '2015-07-01', 'Large Pig'),
			(19, '2018-09-05', '2017-08-01', 'Hen'),
			(19, '2018-10-15', '2017-07-29', 'Hen'),
			(20, '2018-10-15', '2017-07-15', 'Hen'),
			(20, '2018-10-15', '2017-07-20', 'Hen'),
			(20, '2018-10-15', '2017-07-21', 'Rooster');
...
INSERT INTO plant (plot, date_planted, harvest_date, type)
	VALUES  (7, '2016-08-09', '2016-10-19', 'Green Cabbage'),
		    (7, '2016-08-09', '2016-10-19', 'Green Cabbage'),
		    (8, '2016-08-09', '2016-10-19', 'Green Cabbage'),
			(8, '2016-08-09', '2016-10-19', 'Green Cabbage'),
			(3, '2016-08-09', '2016-10-21', 'Potato'),
			(3, '2016-08-09', '2016-10-21', 'Potato'),
			(4, '2016-08-09', '2016-10-21', 'Potato'),
			(4, '2016-08-09', '2016-10-21', 'Potato'),
			(7, '2017-03-27', '2017-07-13', 'Tomato'),
			(7, '2017-03-27', '2017-07-13', 'Tomato'),
			(8, '2017-03-27', '2017-07-13', 'Tomato'),
			(8, '2017-03-27', '2017-07-13', 'Tomato'),
			(23, '2018-05-05', '2015-07-29', 'Cantelope'),
			(23, '2018-05-05', '2015-07-29', 'Cantelope'),
			(24, '2018-05-05', '2015-07-29', 'Cantelope'),
			(24, '2018-05-05', '2015-07-29', 'Cantelope');
